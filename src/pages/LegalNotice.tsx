    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside space-y-2 mb-4">
          <li>
            <strong>Our business name:</strong> BRAIN REPO  
          </li>
          <li>
      ...
      <section className="mb-6">
        ...
        <p className="mb-4">
          ...
          BRAIN REPO. It is not permitted to reproduce and/or publish, in whole or in part,
          ...
          its owner without prior written permission from BRAIN REPO  
        </p>
        <p className="mb-4">
          ...
          strictly prohibited. All intellectual property rights are expressly reserved by BRAIN REPO 
        </p>
        <p>
          BRAIN REPO  will ensure compliance with the aforementioned conditions and the proper
      ...
      <section>
        ...
        <p className="mb-4">
          BRAIN REPO  may modify, without prior notice, the information contained on its website,
          as well as its configuration and presentation.
        </p>
        <p className="mb-4">
          BRAIN REPO  commits, through this medium, to NOT ENGAGE IN MISLEADING ADVERTISING. In this
          regard, any formal or numerical errors found throughout the content of the various sections of
          the BRAIN REPO  website—produced as a consequence of incomplete or defective maintenance and/or
          updating—will not be considered misleading advertising. BRAIN REPO  is committed to correcting
          such errors as soon as they are identified.
        </p>
        <p className="mb-4">
          BRAIN REPO  is not responsible for any breach of applicable regulations that the user might commit
          when accessing this website and/or using the information contained herein.
        </p>
        <p className="mb-4">
          BRAIN REPO  shall not be held liable for any damages or losses, regardless of their nature,
          ...
          offered by third parties through this website are not under the control of BRAIN REPO  and the entity
